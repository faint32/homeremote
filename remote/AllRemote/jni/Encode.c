...
jbyteArray
Java_com_sommer_ircore_RemoteCore_Encode( JNIEnv*  env,jobject jobj,jbyteArray data,jstring codeType ){
...
////////////////////////////////////////////////////////////////////////
		...
		if (strcmp(type,V08ADE)==0){
			...
			length =  sizeof(V08ADE_FORM) / sizeof(char);

			for (i=0;i<length;i++){
				sendCode[i]= V08ADE_FORM[i];
			}
			sendCode[2]= *sendData;
...
////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////////////////
				if (strcmp(type,T16AAU)==0){
					...
					length =  sizeof(T16AAU_FORM) / sizeof(char);

					for (i=0;i<length;i++){
					sendCode[i]= T16AAU_FORM[i];
								//	LOGD("sendData %d ----> 0x%x \n ",i,sendCode[i]);
					}
					sendCode[1]= *sendData;
					sendData++;
